...

{
  ...
  luxnix = {
    ...
    generic-settings.network.hosts.gs-01.syncthing-id =
    ...
    generic-settings.network.hosts.gs-02.syncthing-id =
    ...
    generic-settings.network.hosts.s-01.syncthing-id =
      "WTGG7YQ-AGGOG6H-PQPA54T-HQRCF4P-2T52JSI-OQTIBUG-JUCC45Y-MBCB4QS";

    generic-settings.network.hosts.s-02.domains = [
      "nginx.endo-reg.net"
      "cloud.endo-reg.net"
    ...
    generic-settings.network.hosts.s-02.syncthing-id =
    ...
    generic-settings.network.hosts.s-03.syncthing-id =
    ...
    generic-settings.linux.initrd.availableKernelModules = [
      "xhci_pci"
      "ahci"
      "usbhid"
      "nvme"
    ...
    generic-settings.linux.initrd.kernelModules = [
      "nfs"
      "btrfs"
    ];
    generic-settings.linux.initrd.supportedFilesystems = [
      "nfs"
      "btrfs"
    ];
    ...
    generic-settings.linux.supportedFilesystems = [
      "nfs"
      "btrfs"
    ];
