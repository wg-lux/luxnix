...
lib.foldl' lib.recursiveUpdate
  ...
  [
    ...
    {
      services.luxnix.lxAnnotateLocal.django.djangoAllowedHosts = [
        "lx-annotate.endo-reg.net"
        "localhost"
        "127.0.0.1"
      ];
    }
    {
      services.luxnix.lxAnnotateLocal.django.hostname = "lx-annotate.endo-reg.net";
    }
    {
      services.luxnix.lxAnnotateLocal.django.httpProtocol = "https";
    }
    {
      services.luxnix.lxAnnotateLocal.django.useHttps = true;
    }
    {
