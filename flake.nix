  ...
  outputs =
    ...
    lib.mkFlake {
      ...
      overlays = with inputs; [
        # Use devenv package from the devenv flake input rather than nixpkgs
        # This upgrades devenv independently of the nixpkgs channel version
        (final: prev: {
      ...
      topology =
        ...
        import nix-topology {
          ...
          # Note: use stdenv.hostPlatform.system instead of 'system' (deprecated)
          modules = [
            (import ./topology {
              inherit (host) config;
            })
