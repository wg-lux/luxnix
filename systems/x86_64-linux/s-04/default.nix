...
lib.foldl' lib.recursiveUpdate
  ...
  [
    ...
    {
      roles.endoreg-client.api.djangoDebug = false;
    }
    {
      roles.endoreg-client.api.hostname = "0.0.0.0";
    }
    {
      roles.endoreg-client.api.logLevel = "INFO";
    }
    {
    ...
    {
      roles.endoreg-client.database.name = "endoregDbCentral";
    }
    {
      roles.endoreg-client.database.sslMode = "allow";
    }
    {
      roles.endoreg-client.database.user = "endoregDbCentral";
    }
    {
    ...
    {
      services.luxnix.redis.enable = true;
    }
    {
