      ...
      type = types.submodule {
        options = {
          mode = mkOption {
            ...
            default = "repo";
            description = "How lx-annotate is started. 'repo' keeps the existing git/devenv flow; 'wheel' installs a configured Python wheel into a runtime virtualenv.";
          };
          wheelPath = mkOption {
            type = types.nullOr types.path;
            default = pkgs.fetchurl {
              url = "https://files.pythonhosted.org/packages/f0/bc/75661bd5f6430c51168e738b4711283f4240cdaea30ac367117e2af5f72d/lx_annotate-0.0.3-py3-none-any.whl";
              hash = "sha256-Ip2jV8f+iN3nwJqlDYok4bPedK4edBt/EjpcyaEiyMk=";
            };
