...
def build_nix_system_configs(conf_parent: Path) -> None:
    ...
    for template in conf_dir.glob("*.yml"):
        ...
        generate_nix_system_configuration(hostname, conf_parent=conf_parent)


if __name__ == "__main__":
    build_nix_system_configs(Path("./conf"))
