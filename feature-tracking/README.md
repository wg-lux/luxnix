# Feature tracking for LuxNix cleanup

This directory is the authoritative production-readiness tracker for
LuxNix repository cleanup. It tracks repository content, Nix module ownership,
host configuration, and operational documentation.
...
./feature-tracking/tracker.py show luxnix_repository_cleanup
./feature-tracking/tracker.py show luxnix_host_configuration_cleanup
./feature-tracking/tracker.py validate
./feature-tracking/tracker.py check luxnix_repository_cleanup
```
...
```bash
./feature-tracking/tracker.py update luxnix_repository_cleanup \
...
```bash
./feature-tracking/tracker.py update luxnix_host_configuration_cleanup \
...
```bash
./feature-tracking/tracker.py verify luxnix_repository_cleanup cleanup_is_reproducible
```
...
```bash
./feature-tracking/tracker.py done luxnix_repository_cleanup \
...
```bash
./feature-tracking/tracker.py reopen luxnix_repository_cleanup \
  production_secret_contract \
