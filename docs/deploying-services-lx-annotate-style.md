...
- the `nixtest` suite in [tests/nixtest](/home/admin/dev/luxnix/tests/nixtest)
...
- [Managed Secrets Role](/home/admin/dev/luxnix/modules/nixos/roles/managed-secrets/README.md)
- [lx-annotate Service Module](/home/admin/dev/luxnix/modules/nixos/services/lx-annotate-local/README.md)
