...
lib.foldl' lib.recursiveUpdate
  ...
  [
    ...
    {
      services.luxnix.vllm.gpuMemoryUtilization = 0.85;
    }
    {
      services.luxnix.vllm.host = "127.0.0.1";
    }
    {
      services.luxnix.vllm.maxModelLen = 8192;
    }
    {
      services.luxnix.vllm.model = "Qwen/Qwen2.5-1.5B-Instruct";
    }
    {
